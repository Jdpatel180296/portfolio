...
const Resume = ({ id }) => {
    return (_jsx(motion.section, { id: id, className: "bg-section2 min-h-screen py-16 px-6 flex-col", initial: { opacity: 0, y: 40 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.7, ease: 'easeOut' }, viewport: { once: true, amount: 0.2 }, children: _jsxs("div", { className: "max-w-4xl mx-auto", children: [_jsxs(motion.div, { className: "text-center mb-16", initial: { opacity: 0, y: -20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6, delay: 0.1 }, viewport: { once: true }, children: [_jsx("h1", { className: "section-title", children: "Resume" }), _jsx("p", { className: "text-gray-600 mt-4", children: "My educational background, skills, and professional experience" })] }), _jsx("div", { className: "flex justify-center mb-10", children: _jsxs("a", { href: "/Resume.pdf", className: "btn", target: "_blank", children: [_jsx(Download, { className: "w-4 h-4 mr-2" }), "Download Resume"] }) }), _jsxs(motion.div, { className: "bg-section1 rounded-lg shadow-lg p-8 mb-10", ...fadeInProps, children: [_jsx(SectionHeader, { icon: _jsx(GraduationCap, {}), title: "Education" }), _jsx(TimelineItem, { title: "Master of Science in Computer Science", subtitle: "California State University, Los Angeles", location: "Los Angeles, CA", time: "Aug 2023 \u2013 May 2025", details: ["GPA: 3.89/4"] }), _jsx(TimelineItem, { title: "Bachelor of Engineering in Computer Engineering", subtitle: "Gujarat Technological University", location: "Gujarat, India", time: "Aug 2013 \u2013 Jun 2017", details: ["GPA: 3.44/4"] })] }), _jsxs(motion.div, { className: "bg-section1 rounded-lg shadow-lg p-8 mb-10", ...fadeInProps, children: [_jsx(SectionHeader, { icon: _jsx(Trophy, {}), title: "Skills" }), _jsxs("p", { className: "text-gray-600", children: [_jsx("strong", { children: "Backend & Frameworks:" }), " Java 17, Spring Boot, Hibernate, Node.js, Express.js, GraphQL, Microservices", _jsx("br", {}), _jsx("strong", { children: "Frontend:" }), " React.js, Next.js, TypeScript, Angular, Tailwind, Material UI", _jsx("br", {}), _jsx("strong", { children: "Databases:" }), " PostgreSQL, MySQL, MongoDB, DynamoDB, Redis, Cassandra", _jsx("br", {}), _jsx("strong", { children: "Cloud & DevOps:" }), " AWS (EC2, S3, RDS, Lambda), Azure (App Services, AKS), Docker, Kubernetes, Terraform, Jenkins, GitHub Actions", _jsx("br", {}), _jsx("strong", { children: "Security & APIs:" }), " Spring Security, OAuth2, JWT, Swagger/OpenAPI, HIPAA/GDPR", _jsx("br", {}), _jsx("strong", { children: "Testing:" }), " JUnit, Mockito, Selenium, Cypress, Postman, Performance Testing"] })] }), _jsxs(motion.div, { className: "bg-section1 rounded-lg shadow-lg p-8 mb-10", ...fadeInProps, children: [_jsx(SectionHeader, { icon: _jsx(Briefcase, {}), title: "Work Experience" }), _jsx(TimelineItem, { title: "Software Developer II", subtitle: "United Health (Contract)", location: "USA", time: "Jan 2025 \u2013 Present", details: [
                            ...
                            ] }), _jsx(TimelineItem, { title: "Senior Software Engineer", subtitle: "Cognitive", location: "India", time: "Sep 2017 \u2013 Jul 2023", details: [
